                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Anggota</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center><h3 class="card-title">DATA USER <strong>ASISTEN LABORATORIUM INFORMATIKA</strong></h3></center>
                                <a href="<?php echo base_url('kartuanggota/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data</button></a>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $data->id_asisten; ?></td>
                                                <td><?php echo $data->nim_asisten; ?></td>
                                                <td><?php echo $data->nama_asisten; ?></td>
                                                <td><center><?php echo $data->angkatan_asisten; ?></center></td>
                                                <td><center><?php echo $data->alamat_asisten; ?></center></td>
                                                <!-- <td><center><?php echo $data->ttl_asisten; ?></center></td> -->
                                                <td><center><?php echo $data->email_asisten; ?></center></td>
                                                <td><?php echo $data->notelp_asisten; ?></td>
                                                <td><?php echo $data->instagram_asisten; ?></td>
                                                <!-- <td><?php echo $data->level; ?></td> -->
                                            <?php if($this->session->userdata('akses')=='1'): ?>
                                                <td><center><a href="<?php echo base_url().'kartuanggota/ubah/'.$data->nim_asisten; ?>">Ubah</a></center></td><!-- 
                                                <td><center><a href="<?php echo base_url().'kartuanggota/hapus/'.$data->nim_asisten; ?>">Hapus</a></center></td> -->
                                            <?php endif; ?>
                                            </tr>
                                        <?php
                                        }
