                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Data Lab Sistem Operasi </li>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">UPDATE DATA BARANG <strong>SISTEM OPERASI</strong></h3>
                                </center>
                                <div style="color: red;"><?php echo validation_errors(); ?></div>
                                <?php echo form_open("kondisilab/ubah/" . $lab_sistemoperasi->id_sistemoperasi); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="namabarang_sistemoperasi" type="text" value="
                                                <?php echo set_value('namabarang_sistemoperasi', $lab_sistemoperasi->namabarang_sistemoperasi); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="jumlahbarang_sistemoperasi" type="text" value="
                                                <?php echo set_value($lab_sistemoperasi->jumlahbarang_sistemoperasi); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="satuanbarang_sistemoperasi" type="text" value="
                                                <?php echo set_value($lab_sistemoperasi->satuanbarang_sistemoperasi); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tanggalupdate_sistemoperasi" type="date" value="
                                                    <?php echo set_value('tanggalupdate_sistemoperasi', $lab_sistemoperasi->tanggalupdate_sistemoperasi); ?>">
