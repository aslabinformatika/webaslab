                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">TAMBAH DATA BARANG <strong>SISTEM OPERASI</strong></h3>
                                </center>
                                <div style="color: red;"><?php echo validation_errors(); ?></div>
                                <?php echo form_open("sistemoperasi/tambah_data", array('enctype' => 'multipart/form-data')); ?>
                                <?php
                                $this->load->view('dashboard/data-input-sistemoperasi');
                                ?>
