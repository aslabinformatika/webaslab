                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('statuslab/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <center><?php echo $data->id_sistemoperasi; ?></center>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'statuslab/ubah/' . $data->id_sistemoperasi; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'statuslab/hapus/' . $data->id_sistemoperasi; ?>">Hapus</a></center>
                                                        </td>
                                                    <?php endif; ?>
                                                </tr>
                                            <?php
