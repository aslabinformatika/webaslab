...
class sistemoperasi_model extends CI_Model
{
    ...
    public function validation($mode)
    {
        ...
        $this->form_validation->set_rules('kondisibarang_sistemoperasi', 'Kondisi Barang', 'required');
    ...
    public function save()
    {
        $data = array(
            ...
            "kondisibarang_sistemoperasi" => $this->input->post('kondisibarang_sistemoperasi'),
    ...
    public function edit($namabarang_sistemoperasi)
    {
        $data = array(
            "namabarang_sistemoperasi" => $this->input->post('namabarang_sistemoperasi'),
            "jumlahbarang_sistemoperasi" => ($this->input->post('jumlahbarang_sistemoperasi')),
        ...
        $this->db->where('namabarang_sistemoperasi', $namabarang_sistemoperasi);
    ...
    public function delete($namabarang_sistemoperasi)
    {
        $this->db->where('namabarang_sistemoperasi', $namabarang_sistemoperasi);
