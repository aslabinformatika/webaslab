                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_rpl; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_rpl; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_rpl; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_rpl; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_rpl; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labrpl/ubah/' . $data->id_rpl; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labrpl/hapus/' . $data->id_rpl; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
