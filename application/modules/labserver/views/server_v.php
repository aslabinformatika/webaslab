                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Lab Server </a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('labserver/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_server; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_server; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_server; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_server; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_server; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labserver/ubah/' . $data->id_server; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labserver/hapus/' . $data->id_server; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
