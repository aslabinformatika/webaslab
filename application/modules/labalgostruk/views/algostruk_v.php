                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Lab Algoritma Struktur Data </a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">DATA BARANG <strong>ALGORITMA STRUKTUR DATA</strong></h3>
                                </center>
                                <a href="<?php echo base_url('labalgostruk/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_algostruk; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_algostruk; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_algostruk; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_algostruk; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_algostruk; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labalgostruk/ubah/' . $data->id_algostruk; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labalgostruk/hapus/' . $data->id_algostruk; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
