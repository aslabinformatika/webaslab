                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Lab Algoritma dan Pemrograman </a></li>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_algoprog; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_algoprog; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_algoprog; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_algoprog; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_algoprog; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'algoprog/ubah/' . $data->id_algoprog; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'algoprog/hapus/' . $data->id_algoprog; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
