            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">ALGORITMA DAN PEMROGRAMAN</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Algoritma dan Pemrograman</li>
                                    <li class="breadcrumb-item">Data Lab Algoritma dan Pemrograman</li>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo form_open("algoprog/ubah/" . $lab_algoprog->id_algoprog); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="id_algoprog" type="hidden" value="
                                                <?php echo set_value('id_algoprog', $lab_algoprog->id_algoprog); ?>">
                                    <input class="form-control" name="namabarang_algoprog" type="text" value="
                                                <?php echo set_value('namabarang_algoprog', $lab_algoprog->namabarang_algoprog); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="jumlahbarang_algoprog" type="text" value="
                                                <?php echo $lab_algoprog->jumlahbarang_algoprog; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="satuanbarang_algoprog" type="text" value="
                                                <?php echo $lab_algoprog->satuanbarang_algoprog; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tanggalupdate_algoprog" type="date" value="
                                                    <?php echo $lab_algoprog->tanggalupdate_algoprog; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="kondisi_algoprog" type="text" value="<?php echo $lab_algoprog->kondisi_algoprog; ?>">
