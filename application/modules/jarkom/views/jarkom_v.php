                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Lab Jaringan Komputer </a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('jarkom/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_jarkom; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_jarkom; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_jarkom; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_jarkom; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_jarkom; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'jarkom/ubah/' . $data->id_jarkom; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'jarkom/hapus/' . $data->id_jarkom; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
