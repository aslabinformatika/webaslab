                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Data Lab Jaringan Komputer</li>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">UPDATE DATA BARANG <strong>JARINGAN KOMPUTER</strong></h3>
                                </center>
                                <div style="color: red;"><?php echo validation_errors(); ?></div>
                                <?php echo form_open("jarkom/ubah/" . $lab_jarkom->id_jarkom); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="id_jarkom" type="hidden" value="
                                                <?php echo set_value('id_jarkom', $lab_jarkom->id_jarkom); ?>">
                                    <input class="form-control" name="namabarang_jarkom" type="text" value="
                                                <?php echo set_value('namabarang_jarkom', $lab_jarkom->namabarang_jarkom); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="jumlahbarang_jarkom" type="text" value="
                                                <?php echo $lab_jarkom->jumlahbarang_jarkom; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="satuanbarang_jarkom" type="text" value="
                                                <?php echo $lab_jarkom->satuanbarang_jarkom; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tanggalupdate_jarkom" type="date" value="
                                                    <?php echo $lab_jarkom->tanggalupdate_jarkom; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="kondisi_jarkom" type="text" value="<?php echo $lab_jarkom->kondisi_jarkom; ?>">
