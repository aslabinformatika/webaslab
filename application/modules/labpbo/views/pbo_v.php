                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Data Lab PBO </a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <center>
                                    <h3 class="card-title">DATA BARANG <strong>PEMROGRAMAN BERORIENTASI OBJEK</strong></h3>
                                </center>
                                <a href="<?php echo base_url('labpbo/tambah'); ?>"><button type="button" class="btn btn-info btn-sm">Tambah Data Barang</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center><?php echo $data->namabarang_pbo; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->jumlahbarang_pbo; ?></center>
                                                    </td>
                                                    <td>
                                                        <center><?php echo $data->satuanbarang_pbo; ?></center>
                                                    </td>
                                                    <td><center><?php echo $data->tanggalupdate_pbo; ?></center></td>
                                                    <td>
                                                        <center><?php echo $data->kondisi_pbo; ?></center>
                                                    </td>
                                                    

                                                    <?php if ($this->session->userdata('akses') == '1') : ?>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labpbo/ubah/' . $data->id_pbo; ?>">Ubah</a></center>
                                                        </td>
                                                        <td>
                                                            <center><a href="<?php echo base_url() . 'labpbo/hapus/' . $data->id_pbo; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')" >Hapus</a></center>
